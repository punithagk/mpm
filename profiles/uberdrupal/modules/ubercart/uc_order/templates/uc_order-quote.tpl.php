        ...
        <tr valign="top">
          <td>
            ...
            <table cellpadding="4" cellspacing="0" border="0" width="100%" style="font-family: verdana, arial, helvetica; font-size: small;">
              ...
              <tr>
                <td nowrap="nowrap">
                  <b><?php echo t('Quote Grand Total:'); ?></b>
                </td>
                <td width="48%">
		      ...
		      <td width="98%">
                    ...
                    <tr>
                      <td nowrap="nowrap">
                        <b><?php echo t('Total for this Quote:'); ?>&nbsp;</b>
                      </td>
                      <td>
                        <b><?php echo $order_total; ?></b>
                      </td>
                    ...
                    <tr>
                      <td colspan="2">
                        <br /><br /><b><?php echo t('Products on Quote:'); ?>&nbsp;</b>
		    ...
		    <tr>
			<td colspan="2">
                        <br /><br /><b><?php echo t('Quote Comments:'); ?>&nbsp;</b>
			<?php			   
			...
			?>
              ...
              <tr>
                <td colspan="2">
                  ...
                  <?php if ($help_text) { ?>
                  <p><b><?php echo t('Where can I get help with reviewing my Quote?'); ?></b><br />
                  <?php echo t('To learn more about managing your quotes on !store_link, please visit our <a href="!store_help_url">help page</a>.', array('!store_link' => $store_link, '!store_help_url' => $store_help_url)); ?>
                  <br /></p>
                  <?php } ?>
