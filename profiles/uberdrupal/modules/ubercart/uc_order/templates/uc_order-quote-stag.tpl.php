        ...
        <tr valign="top">
          <td>
            ...
            <table cellpadding="4" cellspacing="0" border="0" width="100%" style="font-family: verdana, arial, helvetica; font-size: small;">
              <tr>
                <td colspan="2" bgcolor="#0097D0" style="color: white;">
              ...
              <tr>
                <td colspan="2">
                  ...
                  <table border="0" cellpadding="1" cellspacing="0" width="100%" style="font-family: verdana, arial, helvetica; font-size: small;">
					...
					<?php $records = print_turnaround_date($order->order_id);
					foreach($records as $record) {
					?>
					 
					 <tr>
                      <td nowrap="nowrap">
                        <b><?php echo t('Print Trunround Date '.$record["product"] ); ?></b>
                      </td>
                      <td width="98%">
                        <?php echo $record["turnaround_date"]; ?>
                      </td>
                    </tr>
					<?php }?>
				  ...
				  <tr>
					...
					<td width="98%">
					  ...
					  <?php foreach ($product->data['attributes'] as $attribute => $option) {
						//if(count($option) ==1 && !empty($option[0]))
			...
			<tr>
				<td colspan="2">                
					<?php echo $comments = uc_order_pane_order_comments('customer',$order);	?>
				</td>
			</tr>
